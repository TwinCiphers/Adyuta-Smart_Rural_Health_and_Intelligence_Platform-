...
print("Loading data...")
df = pd.read_csv('data/governance_queries.csv')
...
with open('governance_classifier.tflite', 'wb') as f:
    f.write(tflite_model)

print("✅ Model successfully trained and exported to governance_classifier.tflite")
