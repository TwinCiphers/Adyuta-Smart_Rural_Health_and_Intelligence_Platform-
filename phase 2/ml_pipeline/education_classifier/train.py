...
print("Loading data...")
df = pd.read_csv('data/education_queries.csv')
...
with open('education_classifier.tflite', 'wb') as f:
    f.write(tflite_model)

print("✅ Model successfully trained and exported to education_classifier.tflite")
