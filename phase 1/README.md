...
- `/phase 1/apps/backend` - Core backend services and APIs (Fastify, Prisma, PostgreSQL, Redis)
- `/phase 2/` - New phase for future creations (Coming Soon)
